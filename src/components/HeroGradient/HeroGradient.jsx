  ...
  useEffect(() => {
    ...
    const material = new THREE.ShaderMaterial({
      uniforms: {
        ...
        color1: { value: new THREE.Color(0xFF6F61) }, // Coral
        color2: { value: new THREE.Color(0xFFD54F) }, // Amber
        color3: { value: new THREE.Color(0x4DB6AC) }, // Teal
        color4: { value: new THREE.Color(0x1E88E5) }, // Indigo
        ax: { value: 5 },
        ay: { value: 2.5 },
        az: { value: 5 },
        aw: { value: 7.5 },
